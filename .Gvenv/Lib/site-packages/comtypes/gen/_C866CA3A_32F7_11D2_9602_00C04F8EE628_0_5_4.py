...
__all__ = [
    'SREHypothesis', 'SAFT44kHz8BitStereo',
    'DISPID_SABufferNotifySize', 'DISPID_SPEEngineConfidence',
    'SAFT32kHz8BitMono', 'eLEXTYPE_PRIVATE5', 'SRARoot',
    'SPEVENTSOURCEINFO', 'SPDKL_CurrentConfig',
    'DISPID_SPELexicalForm', 'DISPID_SVSpeakCompleteEvent',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVAudioOutputStream',
    'ISpeechPhraseInfo', 'DISPID_SPRuleId',
    'DISPID_SRGIsPronounceable', 'ISpeechPhraseProperties',
    'DISPID_SLGetPronunciations', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRGRecoContext', 'SPLEXICONTYPE',
    'ISpeechTextSelectionInformation', 'SpeechLexiconType',
    'eLEXTYPE_PRIVATE10', 'SREPrivate', 'SPPS_Interjection',
    'DISPID_SpeechRecoResult2', 'ISpNotifySink', 'DISPID_SASetState',
    'SP_VISEME_9', 'SAFTNoAssignedFormat', 'DISPID_SpeechVoiceStatus',
    'SAFTExtendedAudioFormat', 'SRAInterpreter', 'SPEVENT',
    'ISpVoice', 'SAFT22kHz16BitMono', 'SPEI_MAX_TTS',
    'SpeechStreamSeekPositionType', 'SPAUDIOSTATE',
    'SPAUDIOBUFFERINFO', 'SPRS_INACTIVE', 'SpMemoryStream',
    'DISPID_SRCESoundStart', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechGrammarRule', 'DISPID_SPRuleEngineConfidence',
    'SDTDisplayText', 'DISPID_SPIRetainedSizeBytes', 'SREStateChange',
    'DISPID_SPEAudioStreamOffset', 'ISpeechXMLRecoResult',
    'SECNormalConfidence', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechLexiconWord', 'ISpeechRecoContext', 'DISPID_SDKEnumKeys',
    'SAFTADPCM_44kHzMono', 'SpObjectToken', 'SpCustomStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVEStreamStart',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechLexiconWord',
    'SpeechTokenShellFolder', 'SPGRAMMARWORDTYPE',
    'ISpeechLexiconPronunciations', 'SRSEDone',
    'DISPID_SpeechRecoResultTimes', 'SVEAudioLevel',
    'DISPID_SRRSaveToMemory', 'eLEXTYPE_PRIVATE4', 'SPPS_Unknown',
    'DISPID_SPPConfidence', 'DISPID_SRRGetXMLErrorInfo', 'SPPHRASE',
    'SGLexical', 'SVEEndInputStream', 'DISPID_SpeechAudioStatus',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVEEnginePrivate',
    'DISPIDSPTSI_SelectionLength', 'SASPause', 'SAFT32kHz16BitMono',
    'DISPID_SpeechDataKey', 'SP_VISEME_14', 'DISPID_SRCBookmark',
    'SpeechCategoryAudioOut', 'SDKLCurrentUser',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE1', 'SGDisplay',
    'DISPID_SVSpeak', 'SASClosed', 'SAFTCCITT_ALaw_22kHzStereo',
    ...
    'SAFTADPCM_11kHzMono', 'eLEXTYPE_PRIVATE15', 'SPPS_Modifier',
    'DISPID_SGRSTText', 'SPINTERFERENCE', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SMSSetData', 'ISpeechAudioBufferInfo',
    'DISPID_SVEVoiceChange', 'SPEI_UNDEFINED',
    'SpeechRetainedAudioOptions', 'DISPID_SRRPhraseInfo',
    'SpMMAudioIn', 'SPEI_MIN_TTS', 'DISPID_SRCRetainedAudio',
    'DISPID_SPEAudioSizeBytes', 'SpeechRecoEvents',
    'DISPID_SRGetFormat', 'SPGS_ENABLED', 'SPTEXTSELECTIONINFO',
    'DISPID_SPCIdToPhone', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPEsCount', 'SPVOICESTATUS', 'SPPS_SuppressWord',
    'DISPID_SWFEFormatTag', 'SP_VISEME_17', 'SAFT22kHz16BitStereo',
    'ISpObjectTokenCategory', 'DISPID_SRRTStreamTime',
    'DISPID_SDKSetStringValue', 'DISPID_SVGetAudioInputs',
    'SGRSTTDictation', 'DISPID_SWFEAvgBytesPerSec', 'SPPS_RESERVED3',
    'DISPID_SPEPronunciation', 'IInternetSecurityMgrSite',
    'DISPID_SVSCurrentStreamNumber', 'SREBookmark',
    'STCInprocHandler', 'DISPID_SVAlertBoundary',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_PRIVATE16',
    'SPVPRI_NORMAL', 'eWORDTYPE_ADDED', 'SpeechTokenIdUserLexicon',
    'SpeechAddRemoveWord', 'ISpeechVoice', 'SPRULESTATE', 'SRTReSent',
    'ISpRecoResult', 'DISPID_SRSCurrentStreamPosition',
    'SRSInactiveWithPurge', 'SAFT32kHz8BitStereo', 'SpeechLoadOption',
    'SRAExport', 'DISPID_SDKGetStringValue', 'DISPID_SPPs_NewEnum',
    'SASRun', 'DISPID_SABIBufferSize', 'SVP_1', 'DISPID_SVGetVoices',
    'DISPID_SPAPhraseInfo', 'SPSModifier', 'SPSHT_NotOverriden',
    'SPBO_TIME_UNITS', 'SGSExclusive', 'SPRECOGNIZERSTATUS',
    'DISPID_SGRsCommitAndSave', 'SREAdaptation', 'DISPID_SRProfile',
    'ISpNotifyTranslator', 'eLEXTYPE_RESERVED6', 'DISPID_SRState',
    'SAFTDefault', 'ISpRecoCategory', 'SRSInactive',
    'DISPID_SGRSTRule', 'SP_VISEME_8', 'SPPHRASERULE',
    'DISPID_SGRAddResource', 'DISPID_SBSWrite', 'DISPID_SPPName',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRGCmdLoadFromObject',
    'SAFT12kHz8BitMono', 'DISPID_SpeechPhraseElements',
    'SPINTERFERENCE_TOOQUIET', 'SPSLMA', 'SBOPause',
    'SREPropertyStringChange', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SGRSTs_NewEnum', 'SP_VISEME_18', 'SPBO_AHEAD',
    'SAFTADPCM_44kHzStereo', 'SPEI_RESERVED5',
    'SAFTCCITT_uLaw_44kHzMono', 'SGLexicalNoSpecialChars',
    'SpeechRegistryUserRoot', 'SPEI_PHONEME', 'SVSFIsNotXML',
    'DISPID_SBSSeek', 'DISPID_SRIsShared', 'SRSActive',
    'ISpeechWaveFormatEx', 'ISpeechObjectTokenCategory',
    'eLEXTYPE_RESERVED7', 'SVSFPersistXML', 'STCAll',
    'DISPID_SDKGetlongValue', 'SVP_13', 'ISpeechPhraseRules',
    'DISPID_SREmulateRecognition', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRGDictationLoad',
    'DISPID_SRGCmdSetRuleState', 'SDKLCurrentConfig',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SDTAlternates', 'SPLO_STATIC',
    'DISPID_SRCERecognitionForOtherContext',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTGSM610_44kHzMono',
    'SSTTDictation', 'DISPID_SPPNumberOfElements',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRAudio',
    'SVEVoiceChange', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SOTGetDescription', 'SPEI_TTS_PRIVATE',
    'SECLowConfidence', 'SWPUnknownWordPronounceable',
    'DISPID_SGRSTType', 'SVF_Emphasis', 'ISpPhrase', 'DISPID_SPPId',
    'SSFMOpenReadWrite', 'DISPID_SRRAlternates', 'SPSMF_UPS',
    'ISpSerializeState', 'DISPID_SPIRule', 'SpSharedRecognizer',
    'SP_VISEME_21', 'DISPID_SRCEHypothesis',
    'DISPID_SGRSTPropertyValue', 'ISpeechMemoryStream', 'SASStop',
    'SVP_4', 'SPSEMANTICERRORINFO', 'SpeechVoiceSpeakFlags',
    'SPXMLRESULTOPTIONS', 'DISPID_SPIEngineId',
    'DISPID_SVGetProfiles', 'DISPID_SRSetPropertyNumber',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISpRecoGrammar',
    'SPSNoun', 'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPAsCount',
    'DISPID_SPRuleFirstElement', 'SAFT48kHz8BitMono',
    'SpeechStreamFileMode', 'SpeechInterference', 'SpAudioFormat',
    'DISPID_SRCEStartStream', 'DISPID_SPARecoResult',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTNextState',
    'DISPID_SOTCDefault', 'SpLexicon', 'DISPID_SRGSetTextSelection',
    'SPCT_COMMAND', 'DISPID_SGRName', '_ISpeechRecoContextEvents',
    'SPWT_PRONUNCIATION', 'SGRSTTTextBuffer', 'SP_VISEME_13',
    'SPVPRIORITY', 'SPAS_PAUSE', 'SAFTNonStandardFormat',
    'SpeechPartOfSpeech', 'DISPID_SGRSRule',
    'DISPID_SpeechObjectTokenCategory',
    'DISPID_SpeechPhraseProperties', 'DISPID_SLPs_NewEnum',
    'DISPID_SpeechPhraseRules', 'SVF_Stressed',
    'DISPID_SpeechPhraseAlternate', 'SPEI_RECO_STATE_CHANGE',
    'SP_VISEME_11', 'DISPID_SRCCreateGrammar', 'SPAS_CLOSED',
    'DISPID_SDKGetBinaryValue', 'ISpeechVoiceStatus',
    'SPDKL_CurrentUser', 'DISPID_SRGState', 'DISPID_SOTCGetDataKey',
    'DISPID_SVEWord', 'SpSharedRecoContext', 'SPSUnknown',
    'SpeechCategoryAppLexicons', 'DISPID_SPEs_NewEnum',
    'DISPID_SRCERecognition', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechPhraseReplacements', 'SPEI_RESERVED2', 'SGRSTTRule',
    'SPEI_END_SR_STREAM', 'SPPHRASEELEMENT', 'DISPID_SASState',
    'DISPID_SVGetAudioOutputs', 'DISPID_SBSFormat',
    'ISpeechRecognizerStatus', 'SVSFParseMask',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPIDSPTSI_ActiveLength',
    'SPPS_LMA', 'DISPID_SPRuleChildren', 'DISPID_SOTCSetId',
    'SpeechGrammarState', 'SPWF_INPUT', 'Speech_StreamPos_Asap',
    'SPEI_FALSE_RECOGNITION', 'SpInprocRecognizer',
    'SDKLLocalMachine', 'DISPID_SRCEInterference',
    'tagSPTEXTSELECTIONINFO', 'SPEI_RESERVED6', 'SVP_0',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPPValue',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechAudioBufferInfo',
    'Speech_Max_Word_Length', 'ISpProperties', 'SPEI_PHRASE_START',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SGSDisabled', 'DISPID_SPACommit',
    'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE19', 'DISPID_SRCPause',
    'DISPID_SRGCmdLoadFromResource', 'ISpeechLexicon',
    'Speech_Default_Weight', 'DISPID_SpeechCustomStream',
    'DISPID_SGRSTransitions', 'eLEXTYPE_PRIVATE20', 'SRTSMLTimeout',
    'DISPID_SLWsCount', 'DISPID_SOTDataKey',
    'ISpeechPhraseReplacements', 'SAFT12kHz8BitStereo',
    'DISPID_SLPPhoneIds', 'DISPID_SLPPartOfSpeech',
    'SpeechRecoContextState', 'DISPID_SWFEBlockAlign',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRCResume', 'SpFileStream',
    'ISpeechRecoGrammar', 'DISPID_SVSLastBookmarkId',
    'SGDSActiveUserDelimited', 'STSF_CommonAppData',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SADefaultFormat',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_7',
    'SAFT16kHz16BitStereo', 'SpeechAudioProperties', 'SGDSActive',
    'SPEI_INTERFERENCE', 'ISpeechGrammarRuleState',
    'SpeechUserTraining', 'DISPID_SGRsCommit', 'SPEI_SOUND_END',
    'SPCT_DICTATION', 'SPPS_NotOverriden', 'SPEI_TTS_AUDIO_LEVEL',
    'SPAO_NONE', 'SP_VISEME_1', 'SPWORDPRONUNCIATIONLIST',
    'SPEI_VOICE_CHANGE', 'SP_VISEME_15', 'WAVEFORMATEX',
    'DISPID_SLWType', 'SVP_9', 'DISPID_SRRTOffsetFromStart',
    'SpeechCategoryPhoneConverters', 'DISPID_SRGDictationUnload',
    'SpeechRuleState', 'ISpeechCustomStream', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SVEViseme', 'DISPID_SGRs_NewEnum', 'SINone',
    'DISPID_SLGenerationId', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE6',
    'DISPID_SCSBaseStream', 'ISpeechMMSysAudio', 'SRERequestUI',
    'IEnumSpObjectTokens', 'DISPID_SpeechLexiconWords',
    'ISpeechLexiconPronunciation', 'ISpStreamFormat',
    'DISPID_SOTIsUISupported', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRTLength', 'DISPID_SVPriority', 'DISPID_SOTRemove',
    'ISpStreamFormatConverter', '_SPAUDIOSTATE', 'SLTUser',
    'SpeechCategoryRecoProfiles',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVEWordBoundary',
    'DISPID_SLWPronunciations', 'SpeechVisemeFeature',
    'SSSPTRelativeToEnd', 'SPWF_SRENGINE', 'tagSTATSTG',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_RESERVED9',
    'ISpeechPhraseAlternate', 'SRESoundEnd', 'SVF_None',
    'ISpeechAudio', 'SPCT_SLEEP', 'DISPID_SRCEFalseRecognition',
    'SVEStartInputStream', 'SREPropertyNumChange',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPIAudioStreamPosition',
    'IStream', 'DISPID_SPRsItem', 'ISpPhraseAlt',
    'ISpeechLexiconWords', 'DISPID_SPIGetText', 'SPPS_Noun',
    'SRSEIsSpeaking', 'SPGS_EXCLUSIVE', 'SITooFast',
    'SPSMF_SAPI_PROPERTIES', 'SLOStatic', 'SDTAll', 'SGRSTTWildcard',
    'SpeechAudioState', 'SECFNoSpecialChars', 'SAFT8kHz8BitStereo',
    ...
    'DISPID_SRGReset', 'DISPID_SVSRunningState',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechBaseStream',
    'DISPID_SRRTTickCount', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCRecognizer', 'DISPID_SGRsCount', 'SPVPRI_ALERT',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE12', 'DISPID_SOTCId',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechVoiceEvent', 'SAFTCCITT_ALaw_11kHzStereo', 'SLTApp',
    'SAFT8kHz8BitMono', 'DISPID_SRCEAudioLevel',
    'DISPID_SPERequiredConfidence', 'IInternetSecurityManager',
    'DISPID_SpeechMemoryStream', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpObjectTokenCategory', 'eWORDTYPE_DELETED',
    'SpeechRegistryLocalMachineRoot', 'SPWORDLIST',
    'DISPID_SRGCmdSetRuleIdState', 'DISPIDSPTSI',
    'DISPID_SpeechObjectToken', 'DISPID_SRCState',
    'DISPID_SDKDeleteKey', 'ISequentialStream',
    'DISPID_SRSetPropertyString', 'DISPID_SRRSpeakAudio',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPLO_DYNAMIC',
    'DISPID_SpeechRecoContext', 'DISPID_SRCEBookmark',
    'SpNullPhoneConverter', 'DISPID_SPEDisplayText', 'SVSFParseSapi',
    'SpWaveFormatEx', 'SpeechEngineProperties', 'SPEI_HYPOTHESIS',
    'SECFDefault', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpeechAudioFormat', 'SECFIgnoreKanaType',
    'DISPID_SRGetPropertyString',
    'SpeechPropertyComplexResponseSpeed', 'SREAllEvents',
    'DISPID_SPPFirstElement', 'DISPID_SPRFirstElement',
    'SRTAutopause', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPILanguageId', 'ISpRecognizer2', 'SECHighConfidence',
    'DISPID_SLAddPronunciation', 'DISPID_SRCRequestedUIType',
    'SPSHT_Unknown', 'ISpObjectWithToken', 'SPAUDIOSTATUS',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechObjectTokens',
    'SWPKnownWordPronounceable', 'ISpeechGrammarRuleStateTransitions',
    'SpNotifyTranslator', 'DISPID_SRCEEndStream',
    'SAFT44kHz16BitMono', 'ISpNotifySource',
    ...
    'DISPID_SLPLangId', 'SPPROPERTYINFO', 'DISPID_SPRulesCount',
    'SpShortcut', 'DISPID_SPPsCount', 'eLEXTYPE_USER',
    'DISPID_SOTCategory', 'SLODynamic', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPRULE', 'SpeechFormatType', 'DISPID_SWFESamplesPerSec',
    'SpeechEmulationCompareFlags', 'SpStream',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE2', 'SGRSTTWord',
    'SVPNormal', 'SVP_16', 'SPEI_RECOGNITION',
    'ISpPhoneticAlphabetConverter', 'DISPID_SMSGetData',
    'SSTTWildcard', 'SSFMCreate', 'SSTTTextBuffer',
    'DISPID_SPEDisplayAttributes', 'SVP_6', 'SPINTERFERENCE_NOISE',
    'SITooQuiet', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPANumberOfElementsInResult', 'ISpEventSource',
    'SPFILEMODE', 'DISPID_SPRulesItem', 'SPRST_INACTIVE',
    'ISpRecognizer', 'SVP_7', 'DISPID_SpeechPhraseBuilder',
    'SpeechGrammarTagDictation', 'SpeechTokenKeyFiles',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRSTWeight',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechRecognizer',
    'SPSSuppressWord', 'DISPID_SOTGetAttribute', 'SPSHORTCUTTYPE',
    'SpeechDataKeyLocation', 'SECFEmulateResult', 'SVSFParseSsml',
    'SVP_20', 'SRADynamic', 'SPPHRASEREPLACEMENT',
    'DISPID_SVSLastBookmark', 'SpeechRunState', 'SPFM_OPEN_READONLY',
    'SpeechAudioFormatType', 'SVP_3', 'SPWORDPRONUNCIATION',
    'DISPID_SPIStartTime', 'SPGS_DISABLED', 'SpMMAudioOut',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLPsCount', 'DISPID_SRStatus', 'SPXRO_Alternates_SML',
    'DISPID_SRRGetXMLResult', 'SRESoundStart', 'SPAO_RETAIN_AUDIO',
    'SPRECOCONTEXTSTATUS', 'DISPID_SDKDeleteValue',
    '__MIDL_IWinTypes_0009', 'DISPID_SAFType', 'DISPID_SLWWord',
    'SVSFlagsAsync', 'SPFM_CREATE', 'SDA_One_Trailing_Space',
    'SpMMAudioEnum', 'DISPID_SRRRecoContext', 'DISPID_SLPsItem',
    'SPDKL_LocalMachine', 'SAFTCCITT_ALaw_44kHzMono', 'SVSFIsXML',
    'SpeechMicTraining', 'SpPhoneConverter', 'DISPID_SMSALineId',
    'ISpRecoGrammar2', 'SWTAdded', 'SPSVerb', 'SVEViseme',
    'SpeechCategoryVoices', 'SPSERIALIZEDRESULT', 'DISPID_SGRClear',
    'SpStreamFormatConverter', 'ISpeechResourceLoader', 'SVEBookmark',
    ...
    'SAFT44kHz8BitMono', 'DISPID_SLPSymbolic', 'ISpeechObjectToken',
    'SpeechDiscardType', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SAFGuid', 'DISPID_SpeechAudioFormat', 'DISPID_SFSOpen',
    'SDTRule', 'DISPID_SLRemovePronunciation', 'DISPID_SPPParent',
    'ISpRecognizer3', 'DISPID_SDKCreateKey', 'SPCS_ENABLED',
    'DISPID_SVEStreamEnd', 'SpVoice', 'SpeechVoicePriority',
    'ISpeechPhraseRule', 'DISPID_SpeechRecoResult',
    'ISpResourceManager', 'SVSFNLPSpeakPunc', 'SREStreamEnd',
    'eLEXTYPE_PRIVATE14', 'DISPID_SGRSTPropertyName', 'SVSFNLPMask',
    'ISpAudio', 'SAFT11kHz8BitMono', 'UINT_PTR', 'eLEXTYPE_PRIVATE17',
    'SVP_19', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SPRuleConfidence', 'SVP_14', 'STSF_AppData',
    'SVEAllEvents', 'SPDKL_DefaultLocation', 'SPRST_ACTIVE',
    'DISPID_SOTId', 'SpeechPropertyResourceUsage',
    'DISPID_SpeechGrammarRules', 'DISPID_SRGDictationSetState',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCEPropertyNumberChange',
    'SAFT24kHz16BitStereo', 'DISPID_SOTRemoveStorageFileName',
    'SPGRAMMARSTATE', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SAEventHandle', 'SPSHORTCUTPAIR',
    'SDA_Two_Trailing_Spaces', 'DISPID_SPPChildren', 'SPSHT_OTHER',
    'SRCS_Disabled', 'SPAR_Medium', 'DISPID_SVSyncronousSpeakTimeout',
    'SPFM_NUM_MODES', 'SPEI_REQUEST_UI', 'SP_VISEME_5',
    'eLEXTYPE_APP', 'SpeechBookmarkOptions', 'SRTEmulated', 'SVP_2',
    'SP_VISEME_2', 'SPSERIALIZEDPHRASE', 'SPRS_ACTIVE', 'SVP_15',
    'DISPID_SPRs_NewEnum', 'SREFalseRecognition', 'SPCS_DISABLED',
    'SPSHT_EMAIL', 'SPPS_Verb', 'SPWT_DISPLAY', 'DISPID_SGRsFindRule',
    'STSF_FlagCreate', 'DISPID_SGRAddState', 'SP_VISEME_4',
    'eLEXTYPE_PRIVATE3', 'SDTAudio', 'SpCompressedLexicon',
    'DISPID_SABIMinNotification', 'SAFT48kHz16BitStereo', 'SVP_5',
    'SAFT24kHz8BitMono', 'SPBINARYGRAMMAR',
    'DISPID_SRCEEnginePrivate', 'DISPID_SPAsItem',
    'DISPID_SRAudioInputStream', 'STCInprocServer',
    'DISPID_SPCLangId', 'ISpStream', 'DISPID_SAStatus',
    'DISPID_SOTCEnumerateTokens', 'SAFT24kHz8BitStereo', 'SPWORDTYPE',
    'DISPID_SPRText', 'SPRECORESULTTIMES', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_PRIVATE13', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SLWLangId', 'SPEI_VISEME', 'SPSFunction',
    'ISpeechPhraseAlternates', 'SAFT11kHz16BitMono', 'SP_VISEME_3',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTGSM610_11kHzMono',
    'SPPS_Noncontent', 'SpeechVoiceEvents', 'SpResourceManager',
    'SPVPRI_OVER', 'DISPID_SRCAudioInInterferenceStatus',
    'SRAORetainAudio', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SMSAMMHandle', 'SpeechVoiceCategoryTTSRate',
    'SSFMOpenForRead', 'DISPID_SFSClose',
    'DISPID_SRCERecognizerStateChange', 'eLEXTYPE_PRIVATE11',
    'SPEI_MAX_SR', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechRecoContextEvents', 'SPPHRASEPROPERTY',
    'SPWT_LEXICAL', 'DISPIDSPTSI_SelectionOffset', 'SVP_10',
    'DISPID_SVSInputSentencePosition', 'SDTReplacement',
    'DISPID_SGRsDynamic', 'DISPID_SRCESoundEnd', 'DISPID_SVEBookmark',
    'SDTProperty', 'SVESentenceBoundary', 'SAFT16kHz16BitMono',
    'SECFIgnoreCase', 'SP_VISEME_16', 'DISPID_SpeechFileStream',
    'SP_VISEME_19', 'SAFT8kHz16BitStereo', 'SpeechWordPronounceable',
    'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRRSetTextFeedback', 'SAFT48kHz16BitMono', 'SP_VISEME_12',
    'DISPID_SOTsItem', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SBSRead',
    'DISPID_SVSLastResult', 'SVSFVoiceMask',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SMSADeviceId',
    'DISPID_SVResume', 'SGSEnabled', 'SVEPrivate',
    'SpeechRecognitionType', 'SVP_18', 'DISPID_SRCERequestUI',
    'SVPAlert', 'ISpeechPhraseElements', '_ISpeechVoiceEvents',
    'SITooLoud', 'DISPID_SAVolume', 'DISPID_SLWsItem',
    'ISpeechRecoResultDispatch', 'DISPID_SPPEngineConfidence',
    'SP_VISEME_20', 'DISPID_SRGetRecognizers',
    'ISpeechPhraseInfoBuilder',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPEsItem',
    'SPRECOSTATE', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SVEPhoneme', 'SRERecognition', 'IEnumString', 'SPAS_RUN',
    'ISpeechFileStream', 'SpPhoneticAlphabetConverter', 'SINoSignal',
    'ISpRecoContext', 'DISPID_SGRSTsItem', 'SVPOver',
    'DISPID_SRRAudioFormat', 'DISPID_SRCVoice', 'DISPID_SRRTimes',
    ...
    'SAFT16kHz8BitMono', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_SR_BOOKMARK', 'SFTSREngine', 'SRAONone',
    'DISPID_SVSVisemeId', 'STCLocalServer', 'STCRemoteServer',
    'DISPID_SRCEPropertyStringChange', 'SAFTCCITT_ALaw_22kHzMono',
    'eLEXTYPE_PRIVATE7', 'SVSFPurgeBeforeSpeak', 'SPCT_SUB_COMMAND',
    'SAFT12kHz16BitMono', 'SVP_21', 'DISPID_SGRId',
    'DISPID_SOTsCount', 'DISPID_SGRSTPropertyId', 'SPAS_STOP',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPRuleParent', 'SBONone',
    'SPAR_High', 'DISPID_SPIProperties',
    'SSSPTRelativeToCurrentPosition', 'SPBO_NONE', 'ISpMMSysAudio',
    'SSFMCreateForWrite', 'DISPID_SVPause', 'SPBOOKMARKOPTIONS',
    'DISPID_SVSPhonemeId', 'DISPID_SDKEnumValues',
    'DISPID_SGRSAddWordTransition', 'SRTStandard',
    'DISPID_SAFSetWaveFormatEx', 'SVP_17', 'SGDSActiveWithAutoPause',
    'SPINTERFERENCE_NONE', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPISaveToMemory', 'DISPID_SPEAudioSizeTime',
    'SAFT22kHz8BitStereo', 'SAFT8kHz16BitMono', 'SDTLexicalForm',
    'SECFIgnoreWidth', 'SVSFDefault', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_RESERVED4',
    'DISPIDSPRG', 'SAFTCCITT_ALaw_11kHzMono', 'SRATopLevel',
    'DISPID_SPEAudioTimeOffset', 'eLEXTYPE_RESERVED8',
    'DISPID_SPRsCount', 'SPSEMANTICFORMAT', 'SWTDeleted',
    'SPPS_Function', 'DISPID_SpeechLexicon',
    'DISPID_SRGSetWordSequenceData', 'SPCONTEXTSTATE',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPIGrammarId', 'SFTInput',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVAudioOutput',
    'DISPID_SRSSupportedLanguages', 'SpeechGrammarTagWildcard',
    'SREInterference', 'SpeechGrammarWordType', 'SRADefaultToActive',
    'DISPID_SGRsAdd', 'ISpeechGrammarRules', 'SpeechAudioVolume',
    'DISPID_SRSAudioStatus', 'DISPID_SRCEAdaptation',
    'ISpGrammarBuilder', 'SpInProcRecoContext',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SLWs_NewEnum',
    'DISPID_SVRate', 'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE8',
    'SVEPhoneme', 'SVP_11', 'SPPS_RESERVED2', 'ISpeechBaseStream',
    'SpeechRuleAttributes', 'ISpXMLRecoResult',
    'SDA_No_Trailing_Space', 'SPSNotOverriden', 'DISPID_SPCPhoneToId',
    'SPRST_NUM_STATES', 'SAFTADPCM_22kHzMono', 'SGRSTTEpsilon',
    'STSF_LocalAppData', 'SITooSlow', 'ISpeechGrammarRule', 'SVP_8',
    'DISPID_SLPType', 'SPADAPTATIONRELEVANCE', 'DISPID_SABIEventBias',
    'ISpeechPhraseReplacement', 'SpeechAllElements',
    'DISPID_SRDisplayUI', 'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechPhoneConverter', 'DISPID_SOTDisplayUI', 'SGDSInactive',
    'DISPID_SVEventInterests', 'DISPID_SPERetainedSizeBytes',
    'SPEI_MIN_SR', 'SAFTGSM610_22kHzMono', 'ISpPhoneConverter',
    'SDTPronunciation', 'SRAImport', 'DISPID_SWFEExtraData',
    'SpeechPropertyNormalConfidenceThreshold', 'SpeechVisemeType',
    'DISPID_SOTCreateInstance', 'DISPID_SRIsUISupported',
    'DISPID_SGRInitialState', 'ISpeechRecoResultTimes',
    'SPSHORTCUTPAIRLIST', 'SREPhraseStart', 'DISPID_SVIsUISupported',
    'eLEXTYPE_PRIVATE18', 'SVP_12', 'SRTExtendableParse',
    'DISPID_SWFEChannels', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRRecognizer', 'DISPID_SVSkip', 'DISPID_SLGetWords',
    'eLEXTYPE_PRIVATE9', 'SAFT24kHz16BitMono', 'ISpRecoContext2',
    'ISpEventSink', 'SPDATAKEYLOCATION', 'SpeechTokenValueCLSID',
    'SPEVENTENUM', 'SPAUDIOOPTIONS', 'DISPID_SPIAudioSizeTime',
    'SREStreamStart', 'Speech_StreamPos_RealTime', 'SAFTText',
    'DISPID_SpeechMMSysAudio', 'ISpeechObjectTokens',
    ...
    'SREAudioLevel', 'DISPID_SPRules_NewEnum', 'SPEI_WORD_BOUNDARY',
    'SPXRO_SML', 'SPPARTOFSPEECH', 'DISPID_SpeechPhoneConverter',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRRDiscardResultInfo',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_SR_PRIVATE', 'SP_VISEME_6',
    'ISpeechPhraseProperty', 'SpTextSelectionInformation',
    'Speech_Max_Pron_Length', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseElement', 'DISPID_SGRSTsCount',
    'DISPID_SpeechPhraseAlternates', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPPsItem', 'SAFT44kHz16BitStereo', 'SPAR_Low',
    'DISPID_SRSClsidEngine', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCreateRecoContext',
    'SPAR_Unknown', 'DISPID_SpeechPhraseInfo',
    'SpeechPropertyAdaptationOn', 'DISPID_SPIEnginePrivateData',
    'ISpObjectToken', 'SP_VISEME_10', 'SAFTGSM610_8kHzMono',
    'ISpeechRecoResult', 'SpeechSpecialTransitionType',
    'SAFT11kHz16BitStereo', 'ISpeechDataKey',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechRecognizer',
    'DISPID_SPIElements', 'ISpeechAudioStatus', 'SDKLDefaultLocation',
    'LONG_PTR', 'SpeechTokenContext', 'SPEI_RESERVED3',
    'DISPID_SRAudioInput', 'DISPID_SRCRetainedAudioFormat',
    'SGPronounciation', 'DISPID_SPRuleName', '_RemotableHandle',
    'DISPID_SRGCommit', 'DISPID_SPRuleNumberOfElements',
    'SPLOADOPTIONS', 'SpeechEngineConfidence', 'DISPID_SABufferInfo',
    'ISpDataKey', 'DISPID_SVStatus', 'DISPID_SGRAttributes',
    'DISPID_SVWaitUntilDone', 'DISPID_SVDisplayUI',
    'SSSPTRelativeToStart', 'DISPID_SRGRules', 'SINoise', 'SPVISEMES',
    'SpeechDictationTopicSpelling', 'SAFT22kHz8BitMono',
    'DISPID_SPRNumberOfElements', 'SPCATEGORYTYPE', 'SPBO_PAUSE',
    'SPFM_OPEN_READWRITE', 'SP_VISEME_0', 'SPEI_RECO_OTHER_CONTEXT',
    'eLEXTYPE_LETTERTOSOUND', 'SPWORD', 'SpPhraseInfoBuilder',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SpeechVoice',
    'SPEI_RESERVED1', 'SPEI_ADAPTATION', 'ISpLexicon',
    'SPPS_RESERVED1', 'DISPID_SGRsItem', 'DISPID_SPIReplacements',
    'SpeechCategoryAudioIn', 'DISPID_SPRDisplayAttributes',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVVolume',
    'SAFT32kHz16BitStereo', 'DISPID_SRCEPhraseStart',
    'SAFT12kHz16BitStereo', 'DISPID_SRCEventInterests',
    'SPSInterjection', 'DISPID_SRGId', 'DISPID_SDKSetLongValue',
    'SPPS_RESERVED4', 'SAFTADPCM_8kHzMono', 'SVSFIsFilename',
    'SRCS_Enabled', 'SpeechTokenKeyAttributes'
]

_check_version('1.1.14', 1725005390.996685)
